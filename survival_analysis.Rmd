...
For region (Midwest is the reference category), the HR value of 0.99 for Northeast suggests that the survival time for contestants from the NE is longer compared to contestants from the Midwest. 
...
However, all of these hazard ratios are not statisticially significant, p-value > 0.05. 

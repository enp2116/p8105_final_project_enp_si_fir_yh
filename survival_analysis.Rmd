...
* $h(t)$ is the hazard function determined by a set of participants' covariates $(x_1, x_2, x_3, x_4)$: $x_1$ is POC, $x_2$ is age during the show, $x_3$ is personality type, $x_4$ is gender, and $x_5$ is region 
